...
// Replace every literal "Roovia" occurrence across the whole repo —
  ...
  for (const item of fs.readdirSync(dir)) {
    ...
    if (stat.isDirectory()) {
      ...
      try {
        ...
        if (content.includes("Roovia")) {
          content = content.replaceAll("Roovia", projectName);
...
console.log('Searching for other files containing "Roovia"...');
